    ...
    <div className="container-xxl py-5">
      <div className="container">
        <div className="row g-5 position-relative" style={{ zIndex: 1 }}>
          <div
            className="col-lg-6 mt-0 flex-column wow fadeInLeft"
            style={{ minHeight: "100%" }}
            data-wow-delay="0.2s"
          >
            <div
          ...
          <div className="col-lg-6 mt-0 d-flex flex-column">
                  ...
                  <div className="d-flex">
                    ...
                    <div className="ps-3">
                      ...
                      <p className="text-muted">
                        {moment(
                          item.attributes.eventDate || item.attributes.createdAt
