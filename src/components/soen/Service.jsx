                    ...
                    <div className="row g-4 py-5">
                        <div className="col-xl-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                            <div className="d-flex py-1 flex-column text-center">
                                <FontAwesomeIcon icon={faChalkboardUser} className="fa-3x flex-shrink-0 text-secondary"/>
                                <div className="ps-2">
                                    <h5 className="mt-3 mb-3 text-secondary">Đội ngũ giảng viên</h5>
                        ...
                        <div className="col-xl-3 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
                            <div className="d-flex py-1 flex-column text-center">
                                <FontAwesomeIcon icon={faComputer} className="fa-3x  flex-shrink-0 text-secondary" />
                                <div className="ps-2">
                                    <h5 className="mt-3 mb-3 text-secondary">Cơ sở vật chất</h5>
                        ...
                        <div className="col-xl-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                            <div className="d-flex py-1 flex-column text-center">
                                <FontAwesomeIcon icon={faBuildingColumns} className="fa-3x flex-shrink-0 text-secondary" />
                                <div className="ps-2">
                                    <h5 className="mt-3 mb-3 text-secondary">Chương trình đào tạo</h5>
                        ...
                        <div className="col-xl-3 col-md-6 wow fadeInUp" data-wow-delay="0.4s">
                            <div className="d-flex py-1 flex-column text-center">
                                <FontAwesomeIcon icon={faGraduationCap} className="fa-3x flex-shrink-0 text-secondary" />
                                <div className="ps-2">
                                    <h5 className="mt-3 mb-3 text-secondary">Phương pháp giảng dạy</h5>
