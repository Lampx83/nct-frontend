...
const SEImageGalery = () => {
  ...
  useEffect(() => {
    const fetchImages = async () => {
      try {
        const response = await fetch('https://fit.neu.edu.vn/admin/api/index-page?populate=deep');
        const data = await response.json();
        
        const galleryImages = data.data.attributes.imagesLibrary.data.map(item => ({
          id: item.id,
